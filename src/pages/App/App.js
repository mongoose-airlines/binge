...
class App extends Component {
  ...
  handleUpdateMovie = async updatedMovieData => {
    ...
    const newMoviesArray = this.state.movies.map(m => m._id === updatedMovie._id ? updatedMovie : m )
    this.setState({movies: newMoviesArray}, () => this.props.history.push('/movies'))
  }
